...
"""
    document = "<!doctype html><html lang='en'><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>FORGE " + mode + " report</title>" + style + "</head><body><div class='wrap'><header><h1>FORGE " + mode + " report</h1>" + nav_html + "</header>" + "".join(sections) + f"<meta id='forge-findings' data-canonical-base64='{payload}'></div></body></html>"
